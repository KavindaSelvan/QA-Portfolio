...
const ToolIcon = ({ src, alt, label }) => (
  <div className="flex flex-col items-center gap-2">
    <img src={src} alt={alt} className="w-16 h-16 md:w-20 md:h-20 object-contain" />
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <div className="flex flex-wrap items-center gap-8 md:gap-10 mt-8">
            <div data-aos="zoom-in" data-aos-delay="600" className="hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-2xl">
              <ToolIcon src="/selenium_logo.jpg" alt="Selenium logo" label="Selenium" />
            </div>
            <div data-aos="zoom-in" data-aos-delay="750" className="hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-2xl">
              <ToolIcon src="/playwright_logo.jpg" alt="Playwright logo" label="Playwright" />
            </div>
          </div>
