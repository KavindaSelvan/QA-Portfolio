...
const About = () => {
  const updatedBio = aboutContent.bio.replace(
    "QA'd 20+ mobile apps",
    "QA'd 20+ mobile apps, and tested 20+ systems as well"
  );
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div
          data-aos="fade-left"
          data-aos-delay="200"
          className="flex-1 text-white mt-8 md:mt-0 relative z-20 w-full"
        >
          ...
          <p
            ...
            dangerouslySetInnerHTML={{ __html: updatedBio }}
          />
          ...
          <div className="flex flex-wrap items-center gap-8 md:gap-10 mt-8">
            ...
            >
              <ToolIcon
                src="/playwright_logo.jpg"
                alt="Playwright logo"
                label="Playwright"
              />
            </div>

            {/* Postman - Updated Logo */}
            <div
              data-aos="zoom-in"
              data-aos-delay="850"
              className="hover:scale-110 transition-transform duration-300 cursor-pointer drop-shadow-2xl"
