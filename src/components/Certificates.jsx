  ...
  >
    <div className="flex items-start gap-4">
      ...
      <div>
        ...
        {!cert.url && (
          <p className="text-white/40 text-[10px] font-semibold mt-2">
            Certificate process is ongoing.
          </p>
        )}
      </div>
    </div>
...
const Certificates = () => {
  return (
    <section id="certificates" className="bg-[#ff2a2a] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 w-full pointer-events-none z-10 transform -translate-y-px rotate-180">
