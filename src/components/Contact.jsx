...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isConfigured) {
      ...
      const mailtoLink = `mailto:${personalInfo.emails.secondary}?subject=Portfolio Contact from ${firstName} ${lastName}&body=${encodeURIComponent(`From: ${firstName} ${lastName}\nEmail: ${email}\n\n${message}`)}`;
              ...
              <div className="flex-1 flex flex-col gap-8 text-xs text-white/70 font-medium">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6">
                  <p className="max-w-[250px] leading-relaxed">
                    For urgent inquiries, reach me at <a href={`mailto:${personalInfo.emails.secondary}`} className="underline hover:text-white transition-colors">{personalInfo.emails.secondary}</a>
                  </p>
